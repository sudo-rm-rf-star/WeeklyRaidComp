...
class MessageRef:
    def __init__(self, message_id: int, guild_id: int, group_id: Optional[int] = None, channel_id: Optional[int] = None, user_id: Optional[int] = None,
                 raid_name: Optional[str] = None, raid_datetime: Optional[DateOptionalTime] = None):
    ...
    def from_dict(item: Dict[str, Any]):
        return MessageRef(message_id=int(item['message_id']),
                          ...
                          raid_datetime=DateOptionalTime.from_timestamp(int(item['timestamp'])) if 'timestamp' in item else None)
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            'timestamp': str(self.raid_datetime.to_timestamp())
        }
