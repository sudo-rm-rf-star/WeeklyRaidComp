...
class EmojiInteractionMessage(DiscordMessage):
    def __init__(self, client: discord.Client, guild: discord.Guild, content: str, emojis: List[str], *args, **kwargs):
        self.client = client
        super(EmojiInteractionMessage, self).__init__(client, guild, content=content, emojis=emojis, *args, **kwargs)
