...
from dokbot.utils.PlayerInteraction import InteractionMessage, _interact
from dokbot.utils.OptionInteraction import OptionInteraction
from dokbot.utils.DiscordRoleInteraction import DiscordRoleInteraction
from dokbot.utils.DiscordChannelInteraction import DiscordChannelInteraction
...
async def create_raidteam(client: discord.Client, discord_guild: discord.Guild, member: GuildMember,
    ...
    team_name = await InteractionMessage.interact(client=client, guild=discord_guild, member=member, content=msg)
    msg = "Please fill in the realm of your team."
    realm = await InteractionMessage.interact(client=client, guild=discord_guild, member=member, content=msg)
